...
def is_between_100_and_999(user_input_number):
    ...
    result = True if (int_number >= 100) and (int_number <1000) else False
...
def get_not_duplicated_three_digit_number():
    ...
    while len(set(str(random_num))) != 3:
        random_num = random.randint(100,999)
...
def get_strikes_or_ball(user_input_number, random_number):
    ...
    for idx, user_num in enumerate(user_input_number):
        for jdx, rand_num in enumerate(random_number):
            if idx == jdx and user_num == rand_num:
                result[0] += 1
            elif idx != jdx and user_num == rand_num:
                result[1] += 1
...
def main():
    ...
    while 1:
        ...
        while 1:
            ...
            if is_yes(one_more_time) or is_no(one_more_time): break
            print("Wrong Input, Input again")

        if is_yes(one_more_time): continue
        elif is_no(one_more_time): break
